...
def build(args, preview=False):
    try:
        ...
        # Assemble the bodies for cut operations
        ...
        if pin.subtraction_body != None:
            pin.subtraction_body.opacity = 0.3
...
class ExperimentalPinCommand(apper.Fusion360CommandBase):
